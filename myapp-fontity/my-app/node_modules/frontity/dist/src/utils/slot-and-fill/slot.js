...
const Slot = (_a) => {
    ...
    react_1.default.createElement(react_1.default.Fragment, null, fills.length > 0
        ? fills.map(({ Fill, props, key }) => (react_1.default.createElement(Fill, Object.assign({ key: key, name: key, data: data }, slotProps, props))))
        : children));
};
